...
Choosing the former will result in more postratification cells (57% more, to be precise).


### Mapping the survey and target population data with MRP-KIT


We now have mappings for our 6 postratification variables:
`q_sex`, `q_state`, `q_educ`, `q_race`, `q_marstat`, `q_age`;
allowing for (at least) `2 * 51 * 6 * 8 * 6 * 4`  possible subsets of interest.
