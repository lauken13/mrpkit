...
##### change the name of tmp_map to be ex_map
...
sae_preds <- fit1$collapsify(poststrat_fit1, variable_aggr = "age")

# generate the population estimate
popn_preds <- fit1$collapsify(poststrat_fit1)
