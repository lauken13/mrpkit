...
It is also possible to have an already summarized post-stratification. If it is the case, then the weight would be the size of each cell. Further, if the entire individual level population is given, the the this argument should be omitted and it would be automatically specify as 1. 
