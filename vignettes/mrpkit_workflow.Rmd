...
This method then will return a data frame with the variable levels and probability of the outcome, `y`. In this example, `age_preds` represents the age-group and the probability of voting for the Box Party for each age-group and each draw.
