...
#'   questions = list("Please identify your age group","Please select your gender","Which pet do you own?", "Response"),
...
#'   questions = list("Which age group are you?","Gender?","Which pet would you like to own?"),
